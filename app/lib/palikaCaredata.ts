...
import CommunityImage from '@/public/assets/images/palika1.png'
import DataDashboardImage from '@/public/assets/images/hOS8.png'
...
interface Benefit {
  ...
  description: string
  points: string[]
  image: string | import('next/dist/shared/lib/image-external').StaticImageData
}
...
export const benefits: Benefit[] = [
  {
    ...
    description:
      'Healthy Ayush provides the tools to simplify healthcare administration, optimize resource allocation, and deliver efficient, citizen-focused care with full transparency.',
    points: [
...
export const faqData: FAQ[] = [
  {
    question: 'How does Healthy Ayush improve citizen health outcomes?',
    answer:
      'By creating a unified digital health record, Healthy Ayush ensures continuity of care across all local health posts. This leads to better diagnoses, reduced errors, and allows for proactive public health interventions based on real-time data.',
  },
  {
    question: 'Is the system difficult for non-technical staff to use?',
    answer:
      'No. Healthy Ayush is designed with a simple, intuitive interface. We prioritize user-friendliness to ensure that healthcare workers, regardless of their technical skill level, can adopt and use the system efficiently with minimal training.',
  },
  {
