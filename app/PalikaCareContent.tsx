...
import { features, stats, benefits, faqData } from '@/app/lib/palikaCaredata'
import HealthyAyushMockup from '@/public/assets/images/healthy-ayush-mockup(1).png'
...
export default function PalikaCareContent() {
  return (
    <div className="bg-white text-slate-800 font-sans">
      <section className="relative bg-white pt-24 pb-16 md:pt-32 md:pb-24 overflow-hidden">
        <div className="absolute inset-x-0 top-0 -z-10 transform-gpu overflow-hidden blur-3xl">
          <div className="relative left-[calc(50%-11rem)] aspect-1155/678 w-36.125rem -translate-x-1/2 rotate-30 bg-linear-to-tr from-[#a7f3d0] to-[#38bdf8] opacity-20 sm:left-[calc(50%-30rem)] sm:w-288.75rem" />
        </div>
        <div className="w-full lg:w-[80%] mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <motion.h1
                variants={itemVariants}
                className="text-4xl md:text-6xl font-extrabold text-teal-900 tracking-tighter"
              >
              ...
              >
                Healthy Ayush is a complete healthcare management system that
            ...
            >
              <Image
                src={HealthyAyushMockup}
                alt="Healthy Ayush dashboard on a tablet"
      ...
      <section id="features" className="py-24 sm:py-32 bg-slate-50">
        <div className="w-full lg:w-[80%] mx-auto px-6">
          ...
          >
            ...
            >
              Healthy Ayush integrates every aspect of municipal healthcare into
          ...
          >
            {stats.map((stat, index) => (
              <motion.div
                key={index}
                variants={itemVariants}
                className="bg-linear-to-br from-slate-50 to-slate-100 p-8 rounded-2xl border border-slate-200/60 transition-all hover:shadow-xl hover:-translate-y-1"
              >
          ...
          {benefits.map((benefit, index) => (
            ...
            >
              <div className={` ${index % 2 !== 0 ? 'lg:col-start-2' : ''}`}>
                <motion.h3
                  variants={itemVariants}
                  className="text-3xl md:text-4xl font-extrabold text-teal-900 tracking-tighter mb-6"
                >
                  {benefit.title}
                </motion.h3>
                <motion.p
                ...
                <ul className="space-y-3">
                  {benefit.points.map((point, pIndex) => (
                    ...
                    >
                      <FiCheckCircle className="text-teal-500 w-6 h-6 mr-3 mt-1 shrink-0" />
      ...
      <section id="faq" className="py-24 sm:py-32 bg-white">
        <div className="w-full lg:w-[80%] mx-auto px-6">
          ...
          >
            <motion.h2
              variants={itemVariants}
              className="text-4xl md:text-5xl font-extrabold text-teal-800 tracking-tighter mb-4"
            >
        ...
        <div className="w-full lg:w-[80%] mx-auto px-6 py-20 sm:py-24 text-center">
          ...
          >
            ...
            <p className="mt-6 text-lg max-w-2xl mx-auto text-slate-300">
              {`Healthy Ayush is the trusted solution for local governments. Let's
